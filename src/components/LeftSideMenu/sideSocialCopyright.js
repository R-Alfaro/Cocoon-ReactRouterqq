          ...
          <div className="side_menu_bottom">
               <div className="side_menu_bottom_inner">
                    <ul className="social_menu">
                         <li>
                              <a href="https://www.pinterest.com/" target="_blank"> <i className="ion ion-social-pinterest"></i> </a>
                         </li>
                         <li>
                              <a href="https://www.facebook.com" target="_blank"> <i className="ion ion-social-facebook"></i> </a>
                         </li>
                         <li>
                              <a href="https://twitter.com" target="_blank"> <i className="ion ion-social-twitter"></i> </a>
                         </li>
                         <li>
                              <a href="https://dribbble.com" target="_blank"> <i className="ion ion-social-dribbble"></i> </a>
                         </li>
                    </ul>
